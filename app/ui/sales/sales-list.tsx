  ...
  return (
    <div className="grid grid-cols-1 gap-3">
      {sales.map((sale) => {
        ...
        return (
          <div key={sale.id} className="rounded border shadow bg-white ">
            <div
            ...
            {isOpen && (
              <div className="border-t px-4 py-3 space-y-4 bg-gray-50 ">
                {/* Passengers */}
                <div>
                  <h4 className="font-semibold text-sm text-teal-600  mb-1">Passengers</h4>
                ...
                {/* Tickets */}
                <div>
                  <h4 className="font-semibold text-sm text-teal-600  mb-1">PNR Information</h4>
                  <ul className="space-y-2">
                    {sale.pnr_list.map((pnr) => (
                      <li key={pnr.id} className="p-2 rounded bg-white border shadow-sm ">
